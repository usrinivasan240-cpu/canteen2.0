...
class LegalPagesScreen extends StatelessWidget {
  ...
  List<Widget> _buildContent(bool isDark) {
    switch (page) {
      case LegalPageType.privacy:
        return _buildPrivacyContent(isDark);
      case LegalPageType.terms:
        return _buildTermsContent(isDark);
      case LegalPageType.refund:
        return _buildRefundContent(isDark);
    }
  }

  List<Widget> _buildPrivacyContent(bool isDark) {
    return [
  ...
  List<Widget> _buildTermsContent(bool isDark) {
    return [
  ...
  List<Widget> _buildRefundContent(bool isDark) {
    return [
  ...
  Widget _section(String title, List<String> paragraphs, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(

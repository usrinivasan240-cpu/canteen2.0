...
export default function ServicePanel({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50/40 pb-12">
      {/* HEADER */}
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-blue-100/80 px-4 py-4 md:px-8 shadow-xs">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="h-10 w-10 rounded-2xl bg-gradient-to-tr from-blue-900 to-blue-800 text-white flex items-center justify-center shadow-lg shadow-orange-500/20">
      ...
      {isSuperAdmin && (
        <div className="max-w-6xl mx-auto px-4 mt-6">
          <div className="flex border-b border-blue-100 space-x-2">
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 text-xs font-bold border-b-2 transition-all cursor-pointer ${
                activeTab === 'canteens' ? 'border-orange-600 text-orange-600 font-black' : 'border-transparent text-gray-500 hover:text-gray-900'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 text-xs font-bold border-b-2 transition-all cursor-pointer ${
                activeTab === 'colleges' ? 'border-orange-600 text-orange-600 font-black' : 'border-transparent text-gray-500 hover:text-gray-900'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 text-xs font-bold border-b-2 transition-all cursor-pointer ${
                activeTab === 'users' ? 'border-orange-600 text-orange-600 font-black' : 'border-transparent text-gray-500 hover:text-gray-900'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 text-xs font-bold border-b-2 transition-all cursor-pointer ${
                activeTab === 'dashboards' ? 'border-orange-600 text-orange-600 font-black' : 'border-transparent text-gray-500 hover:text-gray-900'
              }`}
            >
      ...
      {isSuperAdmin && (
        <div className="max-w-6xl mx-auto px-4 mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white border border-blue-100 rounded-3xl p-5 shadow-sm text-left">
          <div className="space-y-1">
            ...
            <select
              ...
              className="bg-blue-50/55 hover:bg-blue-50 focus:bg-white text-xs px-3.5 py-2 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-semibold text-gray-800 cursor-pointer"
            >
          ...
          <div className="flex gap-6 flex-wrap text-left">
            <div className="bg-blue-50/25 px-4 py-2 border border-blue-100/60 rounded-xl min-w-[120px]">
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wide block">Active Canteens</span>
              <span className="block font-display font-extrabold text-base text-orange-600 mt-0.5">{filteredCanteens.length} canteens</span>
            </div>
            <div className="bg-blue-50/25 px-4 py-2 border border-blue-100/60 rounded-xl min-w-[120px]">
            ...
            <div className="bg-blue-50/25 px-4 py-2 border border-blue-200 rounded-xl min-w-[120px]">
      ...
      <main className="max-w-6xl mx-auto px-4 mt-8 space-y-6">
        ...
        {activeTab === 'colleges' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-fade-in">
            {/* Form */}
            <div className="lg:col-span-4 bg-white border border-blue-100/70 rounded-3xl p-5 md:p-6 shadow-sm space-y-5">
              <div>
              ...
              <form onSubmit={handleCreateCollege} className="space-y-4 text-xs font-sans text-left">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-blue-50/30 hover:bg-blue-50/60 focus:bg-white text-xs px-3.5 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all text-gray-800 font-semibold"
                  />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full text-xs text-gray-600 file:mr-2 file:py-2 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-blue-100 file:text-blue-800 hover:file:bg-blue-200 cursor-pointer"
                  />
                  {colLogo && <img src={colLogo} alt="Logo preview" className="h-10 w-10 rounded-lg object-cover border border-blue-100 mt-1" />}
                </div>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white rounded-xl text-xs py-3 font-bold transition-all shadow-md cursor-pointer flex items-center justify-center space-x-1.5 font-display"
                >
            ...
            {/* Table */}
            <div className="lg:col-span-8 bg-white rounded-3xl border border-blue-100/60 shadow-xs overflow-hidden text-left">
              ...
              <div className="overflow-x-auto text-xs">
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-blue-50/50 border-b border-blue-100/40 text-gray-400 uppercase tracking-wider font-semibold text-[10px]">
                  ...
                  <tbody className="divide-y divide-blue-50 font-sans text-slate-700">
                    {colleges.length === 0 ? (
                      <tr>
                          ...
                          <td className="px-6 py-4 font-bold text-gray-950">
                            <div className="flex items-center gap-2">
                              <label className="relative cursor-pointer group">
                                {c.logoUrl ? <img src={c.logoUrl} alt="" className="h-7 w-7 rounded-lg object-cover border border-blue-100 group-hover:opacity-70 transition" /> : <div className="h-7 w-7 rounded-lg bg-blue-100 flex items-center justify-center text-orange-600 text-[10px] font-bold group-hover:bg-blue-200 transition">{c.name.charAt(0)}</div>}
                                <input
                                  type="file"
                                  accept="image/*"
                                  className="hidden"
              ...
              <div className="bg-white rounded-3xl border border-blue-100/60 shadow-xs overflow-hidden text-left">
                <div className="p-5 border-b border-blue-50/50">
        ...
        {activeTab === 'canteens' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-fade-in">
            ...
            <div className="lg:col-span-4 space-y-6">
              {/* Form Create Canteen */}
              <div className="bg-white border border-blue-100/70 rounded-3xl p-5 shadow-sm space-y-4">
                <div>
                  <h3 className="font-display font-black text-sm text-gray-900 uppercase tracking-wide">
                    Create Canteen
                  </h3>
                ...
                <form onSubmit={handleCreateCanteen} className="space-y-3.5 text-xs font-sans text-left">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      required
                      className="w-full bg-blue-50/30 hover:bg-blue-50/60 focus:bg-white text-xs px-3.5 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all text-gray-800 font-semibold cursor-pointer"
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full text-xs text-gray-600 file:mr-2 file:py-2 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-blue-100 file:text-blue-800 hover:file:bg-blue-200 cursor-pointer"
                    />
                    {cantLogo && <img src={cantLogo} alt="Logo preview" className="h-10 w-10 rounded-lg object-cover border border-blue-100 mt-1" />}
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white rounded-xl text-xs py-3 font-bold transition-all shadow-md cursor-pointer flex items-center justify-center space-x-1.5 font-display"
                          ...
                          <tr key={c.id}>
                            ...
                            <td className="px-6 py-4 text-right flex items-center justify-end space-x-2">
                              <button
                                ...
                                className="text-orange-600 hover:text-blue-900 hover:bg-blue-50 px-2.5 py-1.5 rounded-lg transition cursor-pointer font-bold text-[10px] uppercase border border-blue-200"
                              >
                                View Dashboard
                              </button>
                              <button
        ...
        {activeTab === 'users' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 bg-white rounded-3xl border border-blue-100/60 shadow-xs overflow-hidden text-left">
              <div className="p-5 border-b border-blue-50/50 flex justify-between items-center">
                <div>
                  <h3 className="font-display font-black text-sm text-gray-900 uppercase tracking-wide">
                  ...
                  <tbody className="divide-y divide-blue-50 font-sans text-slate-700">
                    {filteredUsers.length === 0 ? (
                      ...
                      filteredUsers.map(usr => (
                        <tr key={usr.email} className="hover:bg-blue-50/15">
                          <td className="px-6 py-4">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                              ...
                              {usr.canteenId && (
                                <span className="text-[9px] bg-blue-50 text-orange-600 px-2 py-0.5 rounded-full font-bold uppercase border border-blue-100/45">
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-col space-y-1">
                              <select
                                ...
                                className="bg-blue-50/60 border border-blue-100 rounded-lg px-2.5 py-1 text-[11px] font-bold text-blue-900 outline-none cursor-pointer focus:bg-white"
                              >
                                <option value="customer">Customer</option>
                                <option value="chef">Chef</option>
                                <option value="staff">Counter Staff</option>
                              ...
                              <input
                                ...
                                className="bg-blue-50/35 border border-blue-100 rounded-lg px-2 py-0.5 text-[10px] text-gray-700 outline-none focus:bg-white"
                              />
                            </div>
                          </td>
                          <td className="px-6 py-4 text-right flex items-center justify-end gap-1.5">
                            <button
                              ...
                              className="text-orange-600 hover:text-blue-900 hover:bg-blue-50 p-2 rounded-xl transition cursor-pointer border border-blue-100/25"
                              title="Edit User"
                            >
            ...
            <div className="bg-white border border-blue-100 rounded-3xl p-6 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <select
                  ...
                  className="bg-blue-50/50 hover:bg-blue-50 focus:bg-white text-xs px-3.5 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-semibold text-gray-800 cursor-pointer min-w-[200px]"
                >
              ...
              <div className="bg-white border border-blue-100 rounded-3xl shadow-sm overflow-hidden">
                {viewingLoading || !viewingCanteenData ? (
                  <div className="p-12 text-center text-gray-500 flex flex-col items-center justify-center">
                    <div className="h-10 w-10 border-4 border-orange-600 border-t-transparent rounded-full animate-spin mb-4" />
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Full Name</label>
                  <input type="text" value={editName} onChange={e => setEditName(e.target.value)} className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold" />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Email Address</label>
                ...
                <div className="space-y-1">
                  ...
                  <input type="text" value={editPassword} onChange={e => setEditPassword(e.target.value)} placeholder="Enter new password" className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold" />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Access Role</label>
                  <select value={editRole} onChange={e => setEditRole(e.target.value)} className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold cursor-pointer">
                    <option value="customer">Customer</option>
                    <option value="chef">Chef</option>
                    <option value="staff">Counter Staff</option>
                    <option value="owner">Canteen Owner</option>
                ...
                <div className="space-y-1">
                  ...
                  <select value={editColId} onChange={e => setEditColId(e.target.value)} className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold cursor-pointer">
                    <option value="">Select College</option>
                ...
                <div className="space-y-1">
                  ...
                  <select value={editCantId} onChange={e => setEditCantId(e.target.value)} className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold cursor-pointer">
                    <option value="">Select Canteen</option>
                ...
                <div className="space-y-1">
                  ...
                  <select value={editSubId} onChange={e => setEditSubId(e.target.value)} className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold cursor-pointer">
                    <option value="">Select Counter</option>
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block">Posting / Designation</label>
                  <input type="text" value={editPosting} onChange={e => setEditPosting(e.target.value)} placeholder="e.g. Counter 1 Manager" className="w-full bg-blue-50/30 text-xs px-3 py-2.5 border border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 font-semibold" />
                </div>
              </div>
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={handleUpdateUser} className="flex-1 bg-gradient-to-r from-blue-900 to-blue-800 hover:from-blue-800 hover:to-blue-700 text-white rounded-xl py-2.5 text-xs font-bold transition-all shadow-md cursor-pointer">Save Changes</button>
              </div>
            </div>
          </div>
        </div>

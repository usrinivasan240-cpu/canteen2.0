...
link.href = '/EscQ-v2.3.9-universal.apk';
      link.download = 'EscQ-v2.3.9-universal.apk';
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-8">
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">v2.3.9</span>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-bold">EscQ v2.3.9 (Universal)</div>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-[10px] text-gray-500 mt-1">
                <span>v2.3.9 — QR ticket after payment</span>
              </div>

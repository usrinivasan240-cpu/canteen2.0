...
export default function DownloadPage({ onBack }: DownloadPageProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = '/EscQ-v2.5.5-universal.apk';
    link.download = 'EscQ-v2.5.5-universal.apk';
    ...
    <div className={`min-h-screen bg-gray-950 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-8">
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">v2.5.5 - Latest Update</span>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-bold">EscQ v2.5.5 (Universal)</div>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-[10px] text-gray-500 mt-1">
                <span>v2.5.5 — Wallet Visible + Superadmin Live Database</span>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-10">
          ...
          <h2 className="font-display font-bold text-xl sm:text-2xl text-white mt-2">v2.5.5 — Wallet Visible + Superadmin Live Database</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">Wallet now perfectly visible — header wallet button + Settings wallet card with live balance.</p>
          </div>
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            <div className="h-10 w-10 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 mb-3">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">Superadmin live Database — full CRUD on every table (users, colleges, canteens, orders, etc.) dynamically.</p>
          </div>
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            <div className="h-10 w-10 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 mb-3">

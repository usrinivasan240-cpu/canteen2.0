...
export default function DownloadPage({ onBack }: DownloadPageProps) {
  ...
  const handleDownload = () => {
    ...
    a.href = '/EscQ-v2.5.26-universal.apk';
    a.download = 'EscQ-v2.5.26-universal.apk';
    ...
    <div className={`min-h-screen bg-gray-950 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-amber-600 flex items-center justify-center">
               ...
               <span className="text-xs font-mono text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">v2.5.26 - Latest Update</span>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-bold">EscQ v2.5.26 (Universal)</div>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-[10px] text-gray-500 mt-1">
                <span>v2.5.26 — Wallet History + Dark Theme Fixes</span>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-10">
          ...
          <h2 className="font-display font-bold text-xl sm:text-2xl text-white mt-2">v2.5.26 — Wallet History + Dark Theme Fixes</h2>
            <p className="text-xs text-gray-500 mt-2">Updated: 26 Sep 2026</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            ...
            <h3 className="font-display font-bold text-sm text-white mb-1">Registration Fix</h3>
            <p className="text-xs text-gray-500 leading-relaxed">Fixed registration failure — Postgres-resilient signup flow no longer blocked by health checks.</p>
          </div>
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            <div className="h-10 w-10 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 mb-3">
              <Zap className="h-5 w-5" />
            </div>
            <h3 className="font-display font-bold text-sm text-white mb-1">College Parse Fix</h3>
            <p className="text-xs text-gray-500 leading-relaxed">Defensive JSON parsing prevents crash on older college data formats. Safe fallback on parse errors.</p>
          </div>
          <div className="bg-gray-900/60 border border-amber-500/30 rounded-2xl p-5">
            <div className="h-10 w-10 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 mb-3">
              <Shield className="h-5 w-5" />
            </div>
            <h3 className="font-display font-bold text-sm text-white mb-1">Bug Fixes</h3>
            <p className="text-xs text-gray-500 leading-relaxed">General stability improvements and college-specific canteen filtering fixed.</p>
          </div>
        </div>
      </div>

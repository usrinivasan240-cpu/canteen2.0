...
export default function DownloadPage({ onBack }: DownloadPageProps) {
  ...
  const handleDownload = () => {
    ...
    a.href = '/EscQ-v2.5.25-universal.apk';
    a.download = 'EscQ-v2.5.25-universal.apk';
    ...
    <div className={`min-h-screen bg-gray-950 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-amber-600 flex items-center justify-center">
               ...
               <span className="text-xs font-mono text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded-full border border-amber-500/20">v2.5.25 - Latest Update</span>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm font-bold">EscQ v2.5.25 (Universal)</div>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-[10px] text-gray-500 mt-1">
                <span>v2.5.25 — Registration + College Parse Fix</span>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-10">
          ...
          <h2 className="font-display font-bold text-xl sm:text-2xl text-white mt-2">v2.5.25 — Registration + College Parse Fix</h2>

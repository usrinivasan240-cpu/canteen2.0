      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full overflow-hidden">
        ...
        <div className="p-6 text-center space-y-4">
          <p className="text-sm text-gray-600">
            A new version of <span className="font-bold text-violet-700">Violet Bites</span> is available with improvements and bug fixes.
          </p>
          ...
          <div className="flex flex-col gap-3 pt-2">
            <a
              ...
              download
              className="w-full bg-violet-600 hover:bg-violet-700 text-white rounded-xl py-3 text-sm font-semibold transition-all flex items-center justify-center space-x-2 shadow-md"
            >
